...
% legend('Control-Mod','Control-Exp','Anemia-Mod','Anemia-Exp','Passive','Active','Location','southeast');
...
legend('Control-Mod','Control-Exp','Anemia-Mod','Anemia-Exp','Passive','Active','Location','southeast','FontSize',14);
