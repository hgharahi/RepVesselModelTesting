...
Dob.mid.D = 100*(Dob.VisRatio(1:5).*Rn./Dob.RAmid(1:5)).^(1/4);
Dob.endo.D = 100*(Dob.VisRatio(1:5).*Rn./Dob.RAendo(1:5)).^(1/4);
Dob.epi.D = 100*(Dob.VisRatio(1:5).*Rn./Dob.RAepi(1:5)).^(1/4);
