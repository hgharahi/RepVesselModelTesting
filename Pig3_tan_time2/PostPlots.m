...
pl(1) = plot(Control.Ptm(idxC), Control.Dmod(idxC)/100,'-s','linewidth',1.5,'Color',[0    0.4470    0.7410]); hold on
pl(2) = plot(Control.Ptm(idxC), Control.Dexp(idxC)/100,'o','linewidth',2.5,'Color',[0    0.4470    0.7410]);

pl(3) = plot(Anemia.Ptm(idxA), Anemia.Dmod(idxA)/100,'-s','linewidth',1.5,'Color',[0.8500    0.3250    0.0980]);
pl(4) = plot(Anemia.Ptm(idxA), Anemia.Dexp(idxA)/100,'o','linewidth',2.5,'Color',[0.8500    0.3250    0.0980]);

pl(5) = plot(Dob.Ptm(idxD), Dob.Dmod(idxD)/100,'-s','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
pl(6) = plot(Dob.Ptm(idxD), Dob.Dexp(idxD)/100,'o','linewidth',2.5,'Color',[0.9290    0.6940    0.1250]);
...
h1 = figure; hold on;
plot(Control.Ptm(idxC),Control.Act(idxC),'-s','linewidth',1.5);
plot(Anemia.Ptm(idxA),Anemia.Act(idxA),'-s','linewidth',1.5);
plot(Dob.Ptm(idxD),Dob.Act(idxD),'-s','linewidth',1.5);
...
h2 = figure; hold on;
plot(Control.Ptm(idxC),Control.Smeta(idxC),'-s','linewidth',1.5);
plot(Anemia.Ptm(idxA),Anemia.Smeta(idxA),'-s','linewidth',1.5);
plot(Dob.Ptm(idxD),Dob.Smeta(idxD),'-s','linewidth',1.5);
% legend('Control','Anemia','Dob+Anemia','Location','best');
xlabel('p_{tm} (mmHg)');
ylabel('S_{meta} (-)');
set(gca,'FontSize',12);
...
h3 = figure; hold on;
plot(Control.Ptm(idxC),Control.Smyo(idxC),'-s','linewidth',1.5);
plot(Anemia.Ptm(idxA),Anemia.Smyo(idxA),'-s','linewidth',1.5);
plot(Dob.Ptm(idxD),Dob.Smyo(idxD),'-s','linewidth',1.5);
% legend('Control','Anemia','Dob+Anemia','Location','best');
xlabel('p_{tm} (mmHg)');
ylabel('S_{myo} (-)');
set(gca,'FontSize',12);
...
h4 = figure; hold on;
plot(Control.Ptm(idxC),Control.SHR(idxC),'-s','linewidth',1.5);
plot(Anemia.Ptm(idxA),Anemia.SHR(idxA),'-s','linewidth',1.5);
plot(Dob.Ptm(idxD),Dob.SHR(idxD),'-s','linewidth',1.5);
% legend('Control','Anemia','Dob+Anemia','Location','best');
xlabel('p_{tm} (mmHg)');
ylabel('S_{HR} (-)');
set(gca,'FontSize',12);
