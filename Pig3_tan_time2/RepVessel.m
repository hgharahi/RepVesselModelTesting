...
Dob.mid.D = 100*(Dob.VisRatio.*Rn./Dob.RAmid).^(1/4);
Dob.endo.D = 100*(Dob.VisRatio.*Rn./Dob.RAendo).^(1/4);
Dob.epi.D = 100*(Dob.VisRatio.*Rn./Dob.RAepi).^(1/4);

pl(3,1) = plot(Dob.mid.Ptm, Dob.mid.D,'o-','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
pl(3,2) = plot(Dob.endo.Ptm, Dob.endo.D,'o--','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
pl(3,3) = plot(Dob.epi.Ptm, Dob.epi.D,'o-.','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
